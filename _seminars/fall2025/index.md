...
papers:
  - title: Manipulating Artificial Intelligence Models via Poisoning Attacks
    ...
    slides: barberslides.pdf
    pdf: barber.pdf

  - title: Computer Vision and Prediction in Sports
    author: Jack Mahoney
  ...
  - title: Improving Urban Planning through Agent Based Modeling and Q-Learning
    ...
    room: Sci 3610
    slides: kalvodaslides.pdf
    pdf: kalvoda.pdf
    distinctionpaper: true

  - title: "Procedural Content Generation: Evolving Non-Player Character (NPC) Intelligence"
    author: Andrew Lam
    time: 2025-11-12 7:30 PM
    room: Sci 3610
    distinctionslides: true
    slides: lamslides.pdf
    pdf: lam.pdf

  - title: Security Limitations of the CAN Bus and Detection through Power Fingerprinting
    author: Ken Broden
    time: 2025-11-13 6:00 PM
    room: Sci 3610
    distinctionslides: true
    slides: brodenslides.pdf
    pdf: broden.pdf
    distinctionpaper: true

  - title: Challenges of Optical Character Recognition
    author: Orville "El" Anderson
    time: 2025-11-13 6:30 PM
    room: Sci 3610
    distinctionslides: true
  ...
  - title: Assessing Flaws in CAPTCHA Security through Progress in AI    
    ...
    time: 2025-11-13 7:00 PM
    room: Sci 3610
    distinctionslides: true
    slides: stanislowskislides.pdf
    pdf: stanislowski.pdf
    distinctionpaper: true

  - title: Post Quantum Cryptography Lattice-Based Algorithms
    author: Dylan Packer
